<?php
    ...
    $querypem = mysqli_query($con, "SELECT p.*, pp.nama FROM pembelian p join pemasok pp on p.id_pemasok = pp.id_pemasok");
  ...
  if($_GET['hal'] == "edit"){
    ...
    if ($queryupdate){
      ...
      document.location='detailpembelian.php';
        ...
        $querysimpan = mysqli_query($con, "INSERT INTO pembelian VALUES ('','$nama','$no_nota','$tanggal','$pemasok')");
        $querysimpan1 = mysqli_query($con, "INSERT INTO detailpembelian VALUES ('','$no_nota','$jumlah','$harga')");
...
<style>
    ...
    #example1 {
        background: url('foto/download.jpg')no-repeat center fixed;
...
<body class="p">
    ...
    <div class="container mt-5" >
        ...
        <div class="my-5 col-12 col-md-6 tex" >
            ...
            <form action="" method="POST">
                ...
                <div class="mb-3">
                    <label for="merksepatu" class="form-label">Nama Sepatu</label>
    ...
    <div class="mt-3">
        <h2 class="tex">List Pembelian</h2>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                  <a href="detailpembelian.php?hal=dp&id_pembelian=<?php echo $data['id_pembelian']; ?>" class="btn btn-success btn-flat btn-xs"><i class="fa fa-search"></i> </a>    
                            </td>
                        </tr>
                    <?php   
                            $jumlah++;         

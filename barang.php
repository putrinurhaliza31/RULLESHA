        ...
        if ($foto_size > 2097152) {
           ...
           if ($foto_nama != "") {
              ...
              if(in_array($ekstensi, $ekstensi_izin) === true)  {
                ...
                $query = mysqli_query($koneksi, "UPDATE barang SET id_merk='$nama_merk', nama_sepatu='$nama', ukuran_sepatu='$ukuran',harga='$harga',stok ='$stok',detail = '$detail', siswa_foto='$foto_nama_new', id_pemasok='$pemasok' WHERE id_siswa='$idp'");
...
<body id="example1" >
    ...
    <div class="container mt-5">
        ...
        <div class="my-5 col-12 col-md-6">
            <h3 class="text-white">Tambah Produk</h3>

            <form action="" method="POST" enctype="multipart/form-data">
                <div class="mb-3">
                    <label for="merksepatu" class="form-label">Merk Sepatu</label>
                    <select name="merk_sepatu" id="merk_sepatu" class="form-control">
                    <?php
                                $sql = "select * from merksepatu";
                    ...
                    <div id="merksepatu" class="form-text">Masukkan Merk Sepatu</div>
                </div>
                <div class="mb-3">
                    <label for="nama" class="form-label">Nama Sepatu</label>
                    <input type="text" class="form-control" id="nama" name="nama" value="<?= @$nama_merk; ?>"
                        autocomplete="off">
                    <div id="nama" class="form-text">Masukkan Nama Sepatu</div>
                </div>
                <div class="mb-3">
                    <label for="merksepatu" class="form-label">Ukuran Sepatu</label>
                    <input type="text" class="form-control" id="ukuran" name="ukuran"
                        value="<?= @$ukuran; ?>" autocomplete="off">
                    <div id="merksepatu" class="form-text">Masukkan Ukuran Sepatu</div>
                </div>
                <div class="mb-3">
                    <label for="nama" class="form-label">Harga</label>
                    <input type="text" class="form-control" id="harga" name="harga" value="<?= @$harga; ?>"
                        autocomplete="off">
                    <div id="nama" class="form-text">Masukkan Harga</div>
                </div>
                <div class="mb-3">
                    <label for="merksepatu" class="form-label">Stock</label>
                    <input type="text" class="form-control" id="stok" name="stok"
                        value="<?= @$stok; ?>" autocomplete="off">
                    <div id="merksepatu" class="form-text">Masukkan Stock</div>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <?php
                               ...
                               $koneksi = $con->query($sql);
                                if ($koneksi->num_rows > 0) {
                                while($row = $koneksi->fetch_assoc()){
                                echo '<option value="' . $row["id_pemasok"]. '">'. $row['nama'].'</option>';
                                }  
                                } else {
                                echo "0 Result";
                                }   
                    ...
                    <div id="merksepatu" class="form-text">Masukkan Pemasok</div>
                </div>
                <div class="mb-3">
                    <label for="nama" class="form-label">Foto</label>
                    <input type="file" name="pas_foto" class="form-control">
                    <div id="nama" class="form-text">Masukkan Foto</div>
                </div>
                <div class="col-12">
        ...
        <div class="mt-3">
            <h2 class="text-white">List Kategori Sepatu</h2>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="detail.php?hal=detail&id=<?= $data['id_sepatu'];?>"
                                    class="btn btn-success btn-flat btn-xs"><i class="fa fa-search"></i> </a>
